  ...
  template: `
    <div class="animate-pageIn">
      ...
      <div class="card" style="padding:20px;margin-bottom:16px;">
        ...
        <div style="margin-top:12px;padding:10px 14px;background:#FFF9E6;border-radius:10px;font-size:12px;color:#B8860B;line-height:1.6;">
          ⚠️ <strong>拉取云端</strong>会覆盖本地数据，请确保已备份重要数据！
        </div>
      </div>
        ...
        <div style="display:flex;flex-direction:column;gap:12px;">
          ...
          <div style="display:flex;align-items:center;gap:12px;">
            <div style="flex:1;">
              ...
              <div style="font-size:12px;color:var(--text-light);margin-top:2px;">用云端数据覆盖本地数据</div>
            </div>
